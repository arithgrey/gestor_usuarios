			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="controller/mod.php" method="post" role="form" style="display: block;">
								...
								<div style='display:none;' class='response_session well' id='response_session'></div>	
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#login-form").submit(valida_session_user);
	});
</script>
</body>
